...
Ndeq(j,n,i)=ndac.l;
Avemeq(j,n,i)=AvEm.l;
NumSMReq(j,n,i)=Nuclear_Rated.l;
Pnucleareq(j,n,i)=Pnucleartotal.l;
Emtotaleq(j,n,i)=emissiontotal.l;
...
NumSMReq(j,n,i)$(NOT NumSMReq(j,n,i)) = zero;
Pnucleareq(j,n,i)$(NOT Pnucleareq(j,n,i)) = zero;
Emtotaleq(j,n,i)$(NOT Emtotaleq(j,n,i)) = zero;
